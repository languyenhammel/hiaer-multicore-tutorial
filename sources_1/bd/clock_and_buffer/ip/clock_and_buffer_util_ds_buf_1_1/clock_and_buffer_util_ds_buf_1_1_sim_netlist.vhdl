...
--               /home/omowuyi/multicore_dev/multi_core.srcs/sources_1/bd/clock_and_buffer/ip/clock_and_buffer_util_ds_buf_1_1/clock_and_buffer_util_ds_buf_1_1_sim_netlist.vhdl
...
entity clock_and_buffer_util_ds_buf_1_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of clock_and_buffer_util_ds_buf_1_1_util_ds_buf : entity is "util_ds_buf";
end clock_and_buffer_util_ds_buf_1_1_util_ds_buf;

architecture STRUCTURE of clock_and_buffer_util_ds_buf_1_1_util_ds_buf is
...
entity clock_and_buffer_util_ds_buf_1_1 is
  ...
  attribute NotValidForBitStream of clock_and_buffer_util_ds_buf_1_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of clock_and_buffer_util_ds_buf_1_1 : entity is "clock_and_buffer_util_ds_buf_1_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of clock_and_buffer_util_ds_buf_1_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of clock_and_buffer_util_ds_buf_1_1 : entity is "util_ds_buf,Vivado 2024.1";
end clock_and_buffer_util_ds_buf_1_1;

architecture STRUCTURE of clock_and_buffer_util_ds_buf_1_1 is
  ...
  attribute x_interface_parameter of IBUF_DS_P : signal is "XIL_INTERFACENAME CLK_IN_D, BOARD.ASSOCIATED_PARAM DIFF_CLK_IN_BOARD_INTERFACE, CAN_DEBUG false, FREQ_HZ 450000000";
  attribute x_interface_info of IBUF_OUT : signal is "xilinx.com:signal:clock:1.0 IBUF_OUT CLK";
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 450000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN clock_and_buffer_util_ds_buf_1_1_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.clock_and_buffer_util_ds_buf_1_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
